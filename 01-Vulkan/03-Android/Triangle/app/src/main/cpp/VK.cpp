/*
    Inverted traingle but in perspective matrix way
*/
// Include andriod header files
...
// [STEP-2] To express andriod Platform flags supported for Vulkan
// First vulkan code line for all platforms
...
// andriod call backs and andriod global variables
// handle_inputs()
// handle_cmd()
AAssetManager *andriodAssetManager = NULL;

// Vulkan related global variables
// [STEP-2] Instance extension related variables 
uint32_t enableInstanceExtentionCount = 0;

// VK_KHR_SURFACE_EXTENSION_NAME, VK_KHR_ANDRIOD_SURFACE_EXTENSION_NAME, VK_EXT_DEBUG_REPORT_EXTENSION_NAME
...
void android_main(struct android_app* state)
{
    ...
    while(1)
    {
        ...
        if(true == engine.bActive && true == bInitialized)
        {
            // Display
            vkResult = display();
            if(VK_FALSE == vkResult && VK_SUCCESS != vkResult && VK_ERROR_OUT_OF_DATE_KHR != vkResult && VK_SUBOPTIMAL_KHR != vkResult)
            {
                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:", "Display() failed!!!\n");
            }
            // Update
            TsUpdate()
        }
...
handle_cmd()
{
    ...
    {
        // andriodNativeWindow = 
        andriodAssetManager = engine->app->activity->assetManager;
        winWidth = aNativeWindow_getWidth(andriodNativeWindow);
        winHeight = aNativeWindow_getHeight(andriodNativeWindow);
        if(bInitialized == false)
        {
            vkResult = TsInitialize();
            if(VK_SUCCESS != vkResult)
            {
                __android_log_print("TsInitialize() failed\n");
            }
            else{
                __android_log_print("TsInitialize() succeed\n");
            }
        }
        else
        {
            andriodNativeWindow = NULL;
        }
        break;
        // engine.bActive 
    }

    vkResult = TsUninitialize();
    if(VK_SUCCESS != vkResult)
    {
        __android_log_print("TsUninitialize() failed\n");
    }
    else{
        __android_log_print("TsUninitialize() succeed\n");
    }
}
...
VkResult TsInitialize(void)
{
               ...
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateVulkanInstance() failed at %d\n", __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateVulkanInstance() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsGetSupportedSurface() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsGetSupportedSurface() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsGetPhysicalDevice() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsGetPhysicalDevice() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsPrintVkInfo() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsPrintVkInfo() succeeded at %d \n", __LINE__);
               }
              ...
              // Create Vulkan (Logical) device
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateVulkanDevice() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateVulkanDevice() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateSwapchain() failed with %d at %d\n", vkTsResult, __LINE__);
                              vkTsResult = VK_ERROR_INITIALIZATION_FAILED; // Sir will answer while TsResize() chya wedes sangtil ki ka Hardcoded return value?
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateSwapchain() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateImagesAndImageViews() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateImagesAndImageViews() succeeded gives swapchain image count: %d at %d \n", swapchainImageCount, __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateCommandPool() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateCommandPool() succeeded at %d \n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateCommandBuffers() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateCommandBuffers() succeeded at %d \n", __LINE__);
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateVertexBuffer() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateVertexBuffer() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateUniformBuffer() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateUniformBuffer() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateShaders() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateShaders() succeeded at %d \n", __LINE__);
               }
                ...
                if (VK_SUCCESS != vkTsResult)
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateDescriptorSetLayout() failed with %d at %d\n", vkTsResult, __LINE__);
                               return(vkTsResult);
                }
                else
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateDescriptorSetLayout() succeeded at %d \n", __LINE__);
                }
                ...
                if (VK_SUCCESS != vkTsResult)
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreatePipelineLayout() failed with %d at %d\n", vkTsResult, __LINE__);
                               return(vkTsResult);
                }
                else
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreatePipelineLayout() succeeded at %d \n", __LINE__);
                }
                ...
                if (VK_SUCCESS != vkTsResult)
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateDescriptorPool() failed with %d at %d\n", vkTsResult, __LINE__);
                               return(vkTsResult);
                }
                else
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateDescriptorPool() succeeded at %d \n", __LINE__);
                }
                ...
                if (VK_SUCCESS != vkTsResult)
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateDescriptorSet() failed with %d at %d\n", vkTsResult, __LINE__);
                               return(vkTsResult);
                }
                else
                {
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateDescriptorSet() succeeded at %d \n", __LINE__);
                }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateRenderPass() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateRenderPass() succeeded at %d \n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreatePipeline() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreatePipeline() succeeded at %d \n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateFrameBuffers() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateFrameBuffers() succeeded at %d \n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateSemaphores() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateSemaphores() succeeded at %d \n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsCreateFences() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsCreateFences() succeeded at %d \n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsInitialize() -> TsBuildCommandBuffers() failed with %d at %d\n", vkTsResult, __LINE__);
               ...
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> TsBuildCommandBuffers() succeeded at %d \n", __LINE__);
               }
               ...
               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsInitialize() -> Initialization completed successfully at %d \n", __LINE__);
...
VkResult TsResize(int iTsWidth, int iTsHeight)
{
    ...
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> Initialization yet not completed or failed at %d \n", __LINE__);
    ...
    if (vkDevice)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDeviceWaitIdle() is done\n");

        // Check presence of swapchain
        if(VK_NULL_HANDLE == vkSwapchainKHR)
        {
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> vkSwapchainKHR is already null cannot proceed at %d\n", __LINE__);
            vkTsResult = VK_ERROR_INITIALIZATION_FAILED;
            return(vkTsResult);
        }
        ...
        for(uint32_t i = 0; i < swapchainImageCount; i++)
        {
                        ...
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDestroyFramebuffer() is successfully done for %d index\n", i);
        }
        ...
        if(vkFrameBuffer_array)
        {
                        ...
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkFrameBuffer_array released successfully\n");
        }
        ...
        for(uint32_t i = 0; i < swapchainImageCount; i++)

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkFreeCommandBuffers() is successfully done for iteration: %d\n", i);
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkCommandBuffer_array is successfully freed\n");
        ...
        if(vkPipeline)
        {
            ...
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDestroyPipeline() is successfully done\n");
        }
        ...
        if(vkPipelineLayout)

                              {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDestroyPipelineLayout() vkPipelineLayout is successfully released\n");
        ...
        if(vkRenderPass)
        {
                        ...
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDestroyRenderPass() is successfully done\n");
        }    
        ...
        // destroy image views
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDestroyImageView() is successfully done for iteration: %d\n", i);
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> swapchainImageView_array is successfully destroyed\n");
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDestroyImage() is successfully done for iteration: %d\n", i);
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> swapchainImage_array is successfully destroyed\n");
...

        {
                        ...
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsResize() -> vkDestroySwapchainKHR() is successfully done\n");
...

        {
                        ...
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsCreateSwapchain() failed with %d at %d\n", vkTsResult, __LINE__);
        ...
        // [STEP-13] Create Vulkan ImagesAndImageViews
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsCreateImagesAndImageViews() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsCreateRenderPass() failed with %d at %d\n", vkTsResult, __LINE__);
               ...
               vkTsResult = TsCreatePipelineLayout();
...

                {
                               ...
                               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsCreatePipelineLayout() failed with %d at %d\n", vkTsResult, __LINE__);
...
// [STEP-26] Create Pipeline
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsCreatePipeline() failed with %d at %d\n", vkTsResult, __LINE__);
...
// Create Frame Buffer
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsCreateFrameBuffers() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsCreateCommandBuffers() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsResize() -> TsBuildCommandBuffers() failed with %d at %d\n", vkTsResult, __LINE__);
...
VkResult TsDisplay(void)
{
    ...
    if(FALSE == bInitialized)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsDisplay() -> Initialization yet not completed at %d \n", __LINE__);
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        if(VK_ERROR_OUT_OF_DATE_KHR == vkTsResult)
        {
            TsResize(winWidth, winHeight);
        }
        else
        {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsDisplay() -> vkAcquireNextImageKHR() failed with %d at %d \n", vkTsResult, __LINE__);
        return(vkTsResult);
        }
    }
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsDisplay() -> vkWaitForFences() failed with %d at %d \n", vkTsResult, __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsDisplay() -> vkResetFences() failed with %d at %d \n", vkTsResult, __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsDisplay() -> vkQueueSubmit() failed with %d at %d \n", vkTsResult, __LINE__);
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        ...
        {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsDisplay() -> vkQueuePresentKHR() failed with %d at %d \n", vkTsResult, __LINE__);
        return(vkTsResult);
        }
    }
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsDisplay() -> TsUpdateUnifomBuffer() failed with %d at %d \n", vkTsResult, __LINE__);
        return(vkTsResult);
    }
...
void TsUninitialize(void)
{
               ...
               {
                              vkDeviceWaitIdle(vkDevice); // First synchronization function
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDeviceWaitIdle() is done\n");
 
                              // Destroy Fence
                              for(uint32_t i = 0; i < swapchainImageCount; i++)
                              {
                                             vkDestroyFence(vkDevice, vkFence_array[i], NULL);                                       
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyFence() is successfully done for %d index\n", i);
                              }
                              ...
                              if(vkFence_array)
                              {
                                             free(vkFence_array);
                                             vkFence_array = NULL;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkFence_array released successfully\n");
                              }
                              ...
                              if(vkSemaphore_rendercomplete)
                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkSemaphore_rendercomplete released successfully\n");
                              }
                              ...
                              if(vkSemaphore_backbuffer)
                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkSemaphore_backbuffer released successfully\n");
                              }
                              ...
                              {
                                             vkDestroyFramebuffer(vkDevice, vkFrameBuffer_array[i], NULL);
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyFramebuffer() is successfully done for %d index\n", i);
                              }
                              if(vkFrameBuffer_array)
                              {
                                             free(vkFrameBuffer_array);
                                             vkFrameBuffer_array = NULL;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkFrameBuffer_array released successfully\n");
                              } 
                              ...
                              if(vkPipelineLayout)
                              {
                                vkDestroyPipelineLayout(vkDevice, vkPipelineLayout, NULL);
                                vkPipelineLayout = VK_NULL_HANDLE;
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyPipelineLayout() vkPipelineLayout is successfully released\n");
                              }
                              ...
                              if(vkDescriptorSetLayout)
                              {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyDescriptorSetLayout() vkDescriptorSetLayout is successfully released\n");
                              }
                              ...
                              if(vkShaderModule_fragment_shader)
                              {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyShaderModule() vkShaderModule_fragment_shader is successfully done\n");
                              }
                              ...
                              if(vkShaderModule_vertex_shader)
                             {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyShaderModule() vkShaderModule_vertex_shader is successfully done\n");
                              }
                             ...
                             if(uniformData.vkBuffer)
                             {
                               vkDestroyBuffer(vkDevice, uniformData.vkBuffer, NULL);
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done for uniformData.vkBuffer\n");
                              }
                              ...
                              if(uniformData.vkDeviceMemory)
                              {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for uniformData.vkDeviceMemory\n");
                              }
                              ...
                              if(vertexData_position.vkDeviceMemory)
                              {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done\n");
                              }
                              ...
                              if(vertexData_position.vkBuffer)
                              {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done\n");
                              }
                              ...
                              if(vkPipeline)
                              {
                                vkDestroyPipeline(vkDevice, vkPipeline, NULL);
                                vkPipeline = VK_NULL_HANDLE;
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyPipeline() is successfully done\n");
                             }
                              ...
                              if(vkDescriptorPool)
                             {
                                ...
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyDescriptorPool() is successfully done & Descriptor Set is destroyed successfully\n");
                             }
                              ...
                              if(vkRenderPass)
                              {
                                             vkDestroyRenderPass(vkDevice, vkRenderPass, NULL);
                                             vkRenderPass = VK_NULL_HANDLE;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyRenderPass() is successfully done\n");
                              }

                              for(uint32_t i = 0; i < swapchainImageCount; i++)
                              {
                                             vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_array[i]);
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkFreeCommandBuffers() is successfully done for iteration: %d\n", i);
                              }
                              ...
                              if(vkCommandBuffer_array)
                              {
                                             free(vkCommandBuffer_array);
                                             vkCommandBuffer_array = NULL;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkCommandBuffer_array is successfully freed\n");
                              }
                              ...
                              if(vkCommandPool)
                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyCommandPool() is successfully done\n");
                              }
                              ...
                              {
                                             vkDestroyImageView(vkDevice, swapchainImageView_array[i], NULL);
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyImageView() is successfully done for iteration: %d\n", i);
                              }
                              ...
                              if(swapchainImageView_array)
                              {
                                             free(swapchainImageView_array);
                                             swapchainImageView_array = NULL;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> swapchainImageView_array is successfully destroyed\n");
                              }
                              ...
                              {
                                             vkDestroyImage(vkDevice, swapchainImage_array[i], NULL);
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyImage() is successfully done for iteration: %d\n", i);
                              }*/
                              ...
                              if(swapchainImage_array)
                              {
                                             free(swapchainImage_array);
                                             swapchainImage_array = NULL;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> swapchainImage_array is successfully destroyed\n");
                              }                            
                              ...
                              if (vkSwapchainKHR)
                              {
                                             vkDestroySwapchainKHR(vkDevice, vkSwapchainKHR, NULL);
                                             vkSwapchainKHR = VK_NULL_HANDLE;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroySwapchainKHR() is successfully done\n");
                              }
 
                              vkDestroyDevice(vkDevice, NULL);
                              vkDevice = VK_NULL_HANDLE;
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyDevice() is successfully done\n");
               }
               ...
               if (vkTsSurfaceKHR)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroySurfaceKHR() successfully done\n");
               }
               ...
               if (vkTsInstance)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsUninitialize() -> vkDestroyInstance() successfully done\n");
               }
}
...
VkResult TsPrintVkInfo(void)
{
               ...
               // Code
               __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] ********** Print Vulkan Info **********\n");
               for (uint32_t i = 0; i < physicalDeviceCount; i++)
               {
                              ...
                              // API Version
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] API Version = %d.%d.%d\n", majorVersion, minorVersion, patchVersion);
 
                              // Device Name
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device Name = %s\n", vkPhysicalDeviceProperties.deviceName);
 
                              // Device Type
                              switch (vkPhysicalDeviceProperties.deviceType)
                              {
                              case VK_PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU:
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device Type = Integrated GPU (iGPU)\n");
                                             break;
                              case VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU:
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device Type = Discrete GPU (dGPU)\n");
                                             break;
                              case VK_PHYSICAL_DEVICE_TYPE_VIRTUAL_GPU:
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device Type = Virtual GPU (vGPU)\n");
                                             break;
                              case VK_PHYSICAL_DEVICE_TYPE_CPU:
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device Type = CPU\n");
                                             break;
                              case VK_PHYSICAL_DEVICE_TYPE_OTHER:
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device Type = OTHER\n");
                                             break;
                              default:
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device Type = UNKNOWN\n");
                                             break;
                              }
 
                              // Vendor ID
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Vendor ID = 0x%04x\n", vkPhysicalDeviceProperties.vendorID);
 
                              // Device ID
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] Device ID = 0x%04x\n", vkPhysicalDeviceProperties.deviceID);
               }
               ...
               if (vkPhysicalDevice_array)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsPrintVKInfo() -> Succeeded to free global vkPhysicalDevice_array at %d\n", __LINE__);
               }
...
VkResult TsGetPhysicalDevice(void)
{
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDevice() -> First call to vkEnumeratePhysicalDevices() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else if (0 == physicalDeviceCount)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDevice() -> First call to vkEnumeratePhysicalDevices() resulted in physicalDeviceCount to zero at %d\n", __LINE__);
                              vkTsResult = VK_ERROR_INITIALIZATION_FAILED;
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> First call to vkEnumeratePhysicalDevices() succeeded at %d\n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDevice() -> Second call to vkEnumeratePhysicalDevices() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Second call to vkEnumeratePhysicalDevices() succeeded at %d\n", __LINE__);
               }
               ...
               for (uint32_t i = 0; i < physicalDeviceCount; i++)
               {
                              ...
                              for (uint32_t j = 0; j < queueCount; j++)
                              {
                                             if (vkQueueFamilyProperties_array[j].queueFlags & VK_QUEUE_GRAPHICS_BIT) // Compute cha kaam karel kiwan render cha kaam karel kiwan data copy karel
                                             {
                                                            if (VK_TRUE == isQueueSurfaceSupported_array[j])
                                                            {
                                                                           ...
                                                                           //__android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() vkTsPhysicalDevice_selected = %u, graphicsQueueFamilyIndex_selected = %u \n",vkTsPhysicalDevice_selected, graphicsQueueFamilyIndex_selected);
                                                                           bFound = VK_TRUE;
                                                            }
                                             }
                              }
                              ...
                              if (isQueueSurfaceSupported_array)
                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Succeeded to free isQueueSurfaceSupported_array at %d\n", __LINE__);
                              }
                              ...
                              if (vkQueueFamilyProperties_array)
                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Succeeded to free vkQueueFamilyProperties_array at %d\n", __LINE__);
                              }
               ...
               if (VK_TRUE == bFound)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> vkGetPhysicalDeviceProperties() %s physical device with graphics enabled is selected at %d\n", vkPhysicalDeviceProperties_selected.deviceName, __LINE__);
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> is succeeded to select required physical device with graphics enabled at %d\n", __LINE__);
                              ...
                              {
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> is failed to obtain grahics enabled physical device at %d\n", __LINE__);
                                             free(vkPhysicalDevice_array);
                                             vkPhysicalDevice_array = NULL;
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Succeeded to free vkPhysicalDevice_array at %d\n", __LINE__);
               ...
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Selected physical device supports tessellation shader\n");
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Selected physical device not supported tessellation shader\n");
               }

               if (vkPhysicalDeviceFeatures.geometryShader)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Selected physical device supports geometry shader\n");
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevice() -> Selected physical device not supported geometry shader\n");
               }
...
VkResult TsGetSupportedSurface(void)
{
               ...
               vkTsResult = vkCreateAndroidSurfaceKHR(vkTsInstance, &vkAndroidSurfaceCreateInfoKHR, NULL, &vkTsSurfaceKHR);
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetSupportedSurface() -> vkCreateAndroidSurfaceKHR() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetSupportedSurface() -> vkCreateAndroidSurfaceKHR() succeeded at %d\n", __LINE__);
               }
...
VkResult TsCreateVulkanInstance(void)
{
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVulkanInstance() -> TsFillInstanceExtensionNames() failed at %d\n", __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVulkanInstance() -> TsFillInstanceExtensionNames() succeeded at %d\n", __LINE__);
               }
               ...
               if(true == bValidation)
               {
                ...
                if (VK_SUCCESS != vkTsResult)
                {
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVulkanInstance() -> TsFillValidationLayerNames() failed at %d\n", __LINE__);
                                return(vkTsResult);
                }
                else
                {
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVulkanInstance() -> TsFillValidationLayerNames() succeeded at %d\n", __LINE__);
                }
               }              
               ...
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateInstanceInf() -> vkCreateInstance() failed due to incompatible driver (%d) at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else if (vkTsResult == VK_ERROR_EXTENSION_NOT_PRESENT)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateInstanceInf() -> vkCreateInstance() failed due to required extension not present (%d) at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else if (vkTsResult != VK_SUCCESS)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateInstanceInf() -> vkCreateInstance() failed due to unknown reason (%d) at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateInstanceInf() -> vkCreateInstance() succeeded at %d\n", __LINE__);
               }
               ...
               if(true == bValidation)
               {
                ...
                if (VK_SUCCESS != vkTsResult)
                {
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVulkanInstance() -> TsCreateValidationCallbackFunction() failed at %d\n", __LINE__);
                                return(vkTsResult);
                }
                else
                {
                                __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVulkanInstance() -> TsCreateValidationCallbackFunction() succeeded at %d\n", __LINE__);
                }
               }
...
VkResult TsFillInstanceExtensionNames(void)
{
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillInstanceExtensionNames() -> First call to vkEnumerateInstanceExtensionProperties() failad at %d. Exiting...\n", __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> First call to vkEnumerateInstanceExtensionProperties() succeeded at %d\n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillInstanceExtensionNames() -> Second call to vkEnumerateInstanceExtensionProperties() failad at %d. Exiting...\n", __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> Second call to vkEnumerateInstanceExtensionProperties() succeeded at %d\n", __LINE__);
               }
               ...
               for (uint32_t i = 0; i < instanceExtensionCount; i++)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> Vulkan Extension Name = %s\n", instanceExtensionNames_array[i]);
               }
              ...
              // Step 5: Find whether above extension names contain our required 2 extensions VK_KHR_SURFACE_EXTENSION_NAME AND VK_KHR_WIN32_SURFACE_EXTENSION_NAME
               ...
               VkBool32 andriodSurfaceExtentionFound = VK_FALSE;
               ...
               for (uint32_t i = 0; i < instanceExtensionCount; i++)
               {
                              ...
                              if (0 == strcmp(instanceExtensionNames_array[i], VK_KHR_ANDROID_SURFACE_EXTENSION_NAME))
                              {
                                         andriodSurfaceExtentionFound = VK_TRUE;
                                         enabledInstanceExtensionNames_array[enableInstanceExtentionCount++] = VK_KHR_ANDROID_SURFACE_EXTENSION_NAME;
                              }
               ...
               if (VK_FALSE == vulkanSurfaceExtensionFound)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsFillInstanceExtensionNames() -> VK_KHR_SURFACE_EXTENSION_NAME not found at %d\n", __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> VK_KHR_SURFACE_EXTENSION_NAME found at %d\n", __LINE__);
               }
 
               if (VK_FALSE == andriodSurfaceExtentionFound)
               {
                              vkTsResult = VK_ERROR_INITIALIZATION_FAILED; // Return hardcoded failure
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsFillInstanceExtensionNames() -> VK_KHR_ANDROID_SURFACE_EXTENSION_NAME not found at %d\n", __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> VK_KHR_WIN32_SURFACE_EXTENSION_NAME found at %d\n", __LINE__);
               }
               ...
               if (VK_FALSE == debugReportExtensionFound)
               {
                    ...
                    {
                              vkTsResult = VK_ERROR_INITIALIZATION_FAILED; // Return hardcoded failure
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsFillInstanceExtensionNames() -> Validation is on but required VK_EXT_DEBUG_REPORT_EXTENSION_NAME is not supported at %d\n", __LINE__);
                              return(vkTsResult);
                    }
                    else
                    {
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsFillInstanceExtensionNames() -> Validation is off and required VK_EXT_DEBUG_REPORT_EXTENSION_NAME is not supported at %d\n", __LINE__);
                    }
               }
               else
               {
                    if(true == bValidation)
                    {
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> Validation is ON and required VK_EXT_DEBUG_REPORT_EXTENSION_NAME is supported at %d\n", __LINE__);
                    }
                    else
                    {                       
                        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsFillInstanceExtensionNames() -> Validation is off but required VK_EXT_DEBUG_REPORT_EXTENSION_NAME is supported at %d\n", __LINE__);                       
                    }
               }
               ...
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> Enabled Vulkan Instance Extension Name = %s\n", enabledInstanceExtensionNames_array[i]);
               }
 
               //__android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillInstanceExtensionNames() -> ")
...

{
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillValidationLayerNames() -> First call to vkEnumerateInstanceLayerProperties() failad at %d. Exiting...\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillValidationLayerNames() -> First call to vkEnumerateInstanceLayerProperties() succeeded with validationLayerCount %d at %d\n",validationLayerCount, __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillValidationLayerNames() -> Failad to allocate memory for vkLayerProperties_array at %d. Exiting...\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillValidationLayerNames() -> Second call to vkEnumerateInstanceLayerProperties() failad at %d. Exiting...\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillValidationLayerNames() -> Second call to vkEnumerateInstanceLayerProperties() succeeded at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillValidationLayerNames() -> Failad to allocate memory for validationLayerNames_array at %d. Exiting...\n", __LINE__);
...

    {
...

        {
            ...
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillValidationLayerNames() -> Failad to allocate memory for validationLayerNames_array[%d] at %d. Exiting...\n", i, __LINE__);
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillValidationLayerNames() -> Vulkan Instance Layer Name = %s\n", validationLayerNames_array[i]);       
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsFillValidationLayerNames() -> VK_LAYER_KHRONOS_validation is not supported at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillValidationLayerNames() -> VK_LAYER_KHRONOS_validation is supported at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillValidationLayerNames() -> Enabled Vulkan Validation Layer Name %s\n", enabledValidationLayerNames_array[i]);
...

{
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateValidationCallbackFunction() -> vkGetInstanceProcAddr() failed to get function pointer for vkCreateDebugReportCallbackEXT() with %d at %d\n", vkTsResult, __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateValidationCallbackFunction() -> vkGetInstanceProcAddr() succeeded to get function pointer for vkCreateDebugReportCallbackEXT() at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateValidationCallbackFunction() -> vkGetInstanceProcAddr() failed to get function pointer for vkDestroyDebugReportCallbackEXT() with %d at %d\n", vkTsResult, __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateValidationCallbackFunction() -> vkGetInstanceProcAddr() succeeded to get function pointer for vkDestroyDebugReportCallbackEXT() at %d\n", __LINE__);
    ...
    {       
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateValidationCallbackFunction() -> vkCreateDebugReportCallbackEXT_fnptr() failed with %d at %d\n", vkTsResult, __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateValidationCallbackFunction() -> vkCreateDebugReportCallbackEXT_fnptr() succeeded at %d\n", __LINE__);
...
VkResult TsFillDeviceExtensionNames(void)
{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillDeviceExtensionNames() -> First call to vkEnumerateDeviceExtensionProperties() failad at %d. Exiting...\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillDeviceExtensionNames() -> First call to vkEnumerateDeviceExtensionProperties() succeeded at %d\n", __LINE__);

                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillDeviceExtensionNames() -> Device Count = %u\n", deviceExtensionCount);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR]  TsFillDeviceExtensionNames() -> Second call to vkEnumerateDeviceExtensionProperties() failad at %d. Exiting...\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillDeviceExtensionNames() -> Second call to vkEnumerateDeviceExtensionProperties() succeeded at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillDeviceExtensionNames() -> Vulkan Device Extension Name = %s\n", deviceExtensionNames_array[i]);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsFillDeviceExtensionNames() -> VK_KHR_SWAPCHAIN_EXTENSION_NAME not found at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillDeviceExtensionNames() -> VK_KHR_SWAPCHAIN_EXTENSION_NAME found at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsFillDeviceExtensionNames() -> Enabled Vulkan Device Extension Name = %s\n", enabledDeviceExtensionNames_array[i]);
...
VkResult TsCreateVulkanDevice(void)
{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVulkanDevice() -> TsFillDeviceExtensionNames() failed at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVulkanDevice() -> TsFillDeviceExtensionNames() succeeded at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVulkanDevice() -> vkCreateDevice() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVulkanDevice() -> vkCreateDevice() succeeded at %d\n", __LINE__);
...
void TsGetDeviceQueue(void)
{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetDeviceQueue() -> vkGetDeviceQueue() returned NULL for vkQueue\n");
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetDeviceQueue() -> vkGetDeviceQueue() succeeded\n");
...

{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDeviceSurfaceFormatAndColorSpace() -> First call to vkGetPhysicalDeviceSurfaceFormatsKHR() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDeviceSurfaceFormatAndColorSpace() -> First call to vkGetPhysicalDeviceSurfaceFormatsKHR() resulted in formatCount to zero at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDeviceSurfaceFormatAndColorSpace() -> First call to vkGetPhysicalDeviceSurfaceFormatsKHR() succeeded at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDeviceSurfaceFormatAndColorSpace() -> Second call to vkGetPhysicalDeviceSurfaceFormatsKHR() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDeviceSurfaceFormatAndColorSpace() -> Second call to vkGetPhysicalDeviceSurfaceFormatsKHR() succeeded at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDeviceSurfaceFormatAndColorSpace() -> vkSurfaceFormatKHR_array freed successfully vkFormat_color: %d and vkColorSpaceKHR: %d\n", vkFormat_color, vkColorSpaceKHR);
...

{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDevicePresentMode() -> First call to vkGetPhysicalDeviceSurfacePresentModesKHR() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDevicePresentMode() -> First call to vkGetPhysicalDeviceSurfacePresentModesKHR() resulted in presentModeCount to zero at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevicePresentMode() -> First call to vkGetPhysicalDeviceSurfacePresentModesKHR() succeeded at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsGetPhysicalDevicePresentMode() -> Second call to vkGetPhysicalDeviceSurfacePresentModesKHR() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevicePresentMode() -> Second call to vkGetPhysicalDeviceSurfacePresentModesKHR() succeeded at %d\n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsGetPhysicalDevicePresentMode() -> vkPresentModeKHR_array freed successfully vkPresentModeKHR: %d \n", vkPresentModeKHR);
...
VkResult TsCreateSwapchain(VkBool32 vSync)
{
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateSwapchain() -> TsGetPhysicalDeviceSurfaceFormatAndColorSpace() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSwapchain() -> TsGetPhysicalDeviceSurfaceFormatAndColorSpace() succeeded at %d \n", __LINE__);
               }
               ...
               if (VK_SUCCESS != vkTsResult)
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateSwapchain() -> vkGetPhysicalDeviceSurfaceCapabilitiesKHR() failed with %d at %d\n", vkTsResult, __LINE__);
                              return(vkTsResult);
               }
               else
               {
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSwapchain() -> vkGetPhysicalDeviceSurfaceCapabilitiesKHR() succeeded at %d \n", __LINE__);
               }
               ...
               if (UINT32_MAX != vkSurfaceCapabilitiesKHR.currentExtent.width)
               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSwapchain() -> Swapchain Image width x height = %d x %d maxImageCount = %d and minImageCount = %d at %d\n", vkExtent2D_swapchain.width, vkExtent2D_swapchain.height, vkSurfaceCapabilitiesKHR.maxImageCount, vkSurfaceCapabilitiesKHR.minImageCount, __LINE__);
               }
               else
              {
                             // If surface size is already defined then swapchain image size must match with it
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSwapchain() -> Swapchain Image width x height = %d x %d at %d\n", vkExtent2D_swapchain.width, vkExtent2D_swapchain.height, __LINE__);
               }
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateSwapchain() -> TsGetPhysicalDevicePresentMode() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSwapchain() -> TsGetPhysicalDevicePresentMode() succeeded at %d \n", __LINE__);
               ...
               vkSwapchainCreateInfoKHR.compositeAlpha = VK_COMPOSITE_ALPHA_INHERIT_BIT_KHR; //VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR; // MEANS Alhpa = 1.0
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateSwapchain() -> vkCreateSwapchainKHR() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSwapchain() -> vkCreateSwapchainKHR() succeeded at %d \n", __LINE__);
...

{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateImagesAndImageViews() -> vkGetSwapchainImagesKHR() first call failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateImagesAndImageViews() -> vkGetSwapchainImagesKHR() first call failed due to swapchainImageCount zero %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateImagesAndImageViews() -> vkGetSwapchainImagesKHR() first call with swapchain desired image count: %d succeeded at %d \n", swapchainImageCount,  __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateImagesAndImageViews() -> vkGetSwapchainImagesKHR() second call failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateImagesAndImageViews() -> vkGetSwapchainImagesKHR() second call succeeded at %d \n",  __LINE__);
...

               {
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateImagesAndImageViews() -> vkCreateImageView() for iteration:%d failed with error (%d) at %d\n", i, vkTsResult, __LINE__);
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateImagesAndImageViews() -> vkCreateImageView() for iteration:%d succeeded at %d \n", i,  __LINE__);
...

{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateCommandPool() -> vkCreateCommandPool() second call failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateCommandPool() -> vkCreateCommandPool() second call succeeded at %d \n",  __LINE__);
...

{
...

               {
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateCommandBuffers() -> vkAllocateCommandBuffers() for iteration:%d failed with error (%d) at %d\n", i, vkTsResult, __LINE__);
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateCommandBuffers() -> vkAllocateCommandBuffers() for iteration:%d succeeded at %d \n", i,  __LINE__);
...
VkResult TsCreateVertexBuffer(void)
{
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() failed at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() succeeded at %d \n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() failed at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() succeeded at %d \n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() failed at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateVertexBuffer() -> vkMapMemory() succeeded at %d \n", __LINE__);
...
VkResult TsCreateUniformBuffer(void)
{
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateUniformBuffer() -> vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateUniformBuffer() -> vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateUniformBuffer() -> vkAllocateMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateUniformBuffer() -> vkAllocateMemory() succeeded at %d \n", __LINE__);
    } 
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateUniformBuffer() -> vkBindBufferMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateUniformBuffer() -> vkBindBufferMemory() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateUniformBuffer() -> TsUpdateUnifomBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateUniformBuffer() -> TsUpdateUnifomBuffer() succeeded at %d \n", __LINE__);
    }
...
VkResult TsUpdateUnifomBuffer(void)
{
    ...
    myuniformData.modelMatrix = glm::translate(
        ...
        glm::vec3(0.0f, 0.0f, -3.0f)    // Translation Vector x, y, z
    );
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsUpdateUnifomBuffer() -> vkMapMemory() Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
...
VkResult TsCreateShaders(void)
{
    ...
    asset = AAssetManager_open(andriodAssetManager, szFileName, AASSET_MODE_BUFFER);
    if(NULL == asset)
    {        
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateShaders() -> The SPIRV shader file size 0 %s at %d\n", szFileName, __LINE__);
        vkTsResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateShaders() -> Succeeded to read %s at %d\n", szFileName, __LINE__);
    }

    size = AAsset_getLength(asset);
    if(size != 0)
    {
            // Error handling for size zero
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateShaders() -> The SPIRV shader file size 0 %s at %d\n", szFileName, __LINE__);
            vkTsResult = VK_ERROR_INITIALIZATION_FAILED;    
            return(vkTsResult);
    }
    ...
    int ret = AAsset_read(asset, shaderData, size);
    if(ret != size)
    {
            // Error handling for size zero
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateShaders() -> The SPIRV shader file size 0 %s at %d\n", szFileName, __LINE__);
    ...
    if(NULL == fp)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateShaders() -> vkCreateShaderModule() Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateShaders() -> vkCreateShaderModule() Succeeded at %d\n", __LINE__);
    }
    ...
    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateShaders() -> Vertex Shader Module is successfully created!!!\n");
    ...
    if(NULL == asset)
    {        
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateShaders() -> The fragment shader file size 0 %s at %d\n", szFileName, __LINE__);
        vkTsResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkTsResult);
    }
    else
    ...
    intretVal = AAsset_read(asset, shaderData, size);
    if(ret != size)
    {
            // Error handling for size zero
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateShaders() -> The fragment shader file size 0 %s at %d\n", szFileName, __LINE__);
    ...
    if(NULL == fp)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateShaders() -> vkCreateShaderModule() Failed in fragement shader at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateShaders() -> vkCreateShaderModule() Succeeded in fragment shader at %d\n", __LINE__);
    }
    ...
    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateShaders() -> Fragment Shader Module is successfully created!!!\n");
...
VkResult TsCreateDescriptorSetLayout(void)
{
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateDescriptorSetLayout() -> vkCreateDescriptorSetLayout() Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateDescriptorSetLayout() -> vkCreateDescriptorSetLayout() Succeeded at %d\n", __LINE__);
    }
...

{
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreatePipelineLayout() -> vkCreatePipelineLayout() Failed at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreatePipelineLayout() -> vkCreatePipelineLayoutg() Succeeded at %d\n", __LINE__);
 ...
 VkResult TsCreateDescriptorPool(void)
 {
    ...
    if (VK_SUCCESS != vkTsResult)
    {
                    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateDescriptorPool() -> vkCreateDescriptorPool() failed with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
    }
    else
    {
                    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateDescriptorPool() -> vkCreateDescriptorPool() succeeded at %d \n",  __LINE__);
    }
...
VkResult TsCreateDescriptorSet(void)
{
   ...
   // vkDescriptorSetAllocateInfo.flags = 0;
    ...
    if (VK_SUCCESS != vkTsResult)
    {
                    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateDescriptorSet() -> vkAllocateDescriptorSets() failed with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
    }
    else
    {
                    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateDescriptorSet() -> vkAllocateDescriptorSets() succeeded at %d \n",  __LINE__);
    }
    ...
    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] vkUpdateDescriptorSets() is run successfully!!! at %d\n", __LINE__);
...
VkResult TsCreateRenderPass(void)
{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateRenderPass() -> vkCreateRenderPass() failed with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateRenderPass() -> vkCreateRenderPass() succeeded at %d \n",  __LINE__);
...

{
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreatePipeline() -> vkCreatePipelineCache() Failed at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreatePipeline() -> vkCreatePipelineCache() Succeeded at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreatePipeline() -> vkCreateGraphicsPipelines() Failed at %d\n", __LINE__);
...

        {
            ...
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreatePipeline() -> vkDestroyPipelineCache() Succeeded at %d\n", __LINE__);
...

    {
        ...
        __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreatePipeline() -> vkCreateGraphicsPipelines() Succeeded at %d\n", __LINE__);
...

{
...

               {
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateFrameBuffers() -> vkCreateFramebuffer() failed for %d index with %d at %d\n", i, vkTsResult, __LINE__);
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateFrameBuffers() -> vkCreateFramebuffer() succeeded  for %d index at %d \n", i, __LINE__);
...

{
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateSemaphores() -> vkCreateSemaphore() failed for vkSemaphore_backbuffer with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSemaphores() -> vkCreateSemaphore() succeeded for vkSemaphore_backbuffer at %d \n", __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateSemaphores() -> vkCreateSemaphore() failed for vkSemaphore_rendercomplete with %d at %d\n", vkTsResult, __LINE__);
...

               {
                              ...
                              __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateSemaphores() -> vkCreateSemaphore() succeeded for vkSemaphore_rendercomplete at %d \n", __LINE__);
...

{
...

               {
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsCreateFences() -> vkCreateFence() failed for %d index with %d at %d\n", i, vkTsResult, __LINE__);
...

                              {
                                             ...
                                             __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsCreateFences() -> vkCreateFence() succeeded for %d index at %d \n", i, __LINE__);
...
VkResult TsBuildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        if (VK_SUCCESS != vkTsResult)
        {
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsBuildCommandBuffers() -> vkResetCommandBuffer() failed for %d index with %d at %d\n", i, vkTsResult, __LINE__);
            return(vkTsResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsBuildCommandBuffers() -> vkResetCommandBuffer() succeeded for %d index at %d \n", i, __LINE__);
        }
        ...
        if (VK_SUCCESS != vkTsResult)
        {
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsBuildCommandBuffers() -> vkBeginCommandBuffer() failed for %d index with %d at %d\n", i, vkTsResult, __LINE__);
            return(vkTsResult);
        }
        else
        {
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsBuildCommandBuffers() -> vkBeginCommandBuffer() succeeded for %d index at %d \n", i, __LINE__);
        }
...

        {
            ...
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[ERROR] TsBuildCommandBuffers() -> vkEndCommandBuffer() failed for %d index with %d at %d\n", i, vkTsResult, __LINE__);
...

        {
            ...
            __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[INFO] TsBuildCommandBuffers() -> vkEndCommandBuffer() succeeded for %d index at %d \n", i, __LINE__);
...

{
    ...
    __android_log_print(ANDROID_LOG_INFO,"ARTR_TS:",  "[TS_VALIDATION]: debugReportCallback() -> %s (%d) = %s\n", pLayerPrefix, messageCode, pMessage);
