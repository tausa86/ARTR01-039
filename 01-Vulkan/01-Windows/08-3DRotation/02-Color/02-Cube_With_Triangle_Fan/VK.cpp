...
VkResult TsCreatePipeline(void)
{
    ...
    vkPipelineInputAssemblyStateCreateInfo.topology = VK_PRIMITIVE_TOPOLOGY_TRIANGLE_FAN; //VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST;
...
VkResult TsBuildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdDraw(vkCommandBuffer_array[i],
            4,  // Kiti vertices draw karaychet
            1, // Kiti instances aahet 1
            4, // Drawing koothoon start karaych
            0  // From 1st instance
        );
        ...
        vkCmdDraw(vkCommandBuffer_array[i],
            4,  // Kiti vertices draw karaychet
            1, // Kiti instances aahet 1
            8, // Drawing koothoon start karaych
            0  // From 1st instance
        );
        ...
        vkCmdDraw(vkCommandBuffer_array[i],
            4,  // Kiti vertices draw karaychet
            1, // Kiti instances aahet 1
            12, // Drawing koothoon start karaych
            0  // From 1st instance
        );
        ...
        vkCmdDraw(vkCommandBuffer_array[i],
            4,  // Kiti vertices draw karaychet
            1, // Kiti instances aahet 1
            16, // Drawing koothoon start karaych
            0  // From 1st instance
        );
        ...
        vkCmdDraw(vkCommandBuffer_array[i],
            4,  // Kiti vertices draw karaychet
            1, // Kiti instances aahet 1
            20, // Drawing koothoon start karaych
            0  // From 1st instance
        );
