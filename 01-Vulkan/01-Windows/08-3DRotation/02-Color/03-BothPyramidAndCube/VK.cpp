...
VertexData vertexData_color_pyramid;
VertexData vertexData_color_cube;
...
void TsUninitialize(void)
{
               ...
               if (vkDevice)
               {
                              ...
                              if(vertexData_position_cube.vkDeviceMemory)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for vertexData_position_cube.vkDeviceMemory\n");
                              }
                              ...
                              if(vertexData_position_cube.vkBuffer)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done for vertexData_position_cube.vkBuffer\n");
                              }
                              ...
                              if(vertexData_position_pyramid.vkDeviceMemory)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for vertexData_position_pyramid.vkDeviceMemory\n");
                              }
                              ...
                              if(vertexData_position_pyramid.vkBuffer)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done for vertexData_position_pyramid.vkBuffer\n");
                              }
...
VkResult TsCreateVertexBuffer(void)
{
    ...
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() failed for vertexData_position_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    ...
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() succeeded for vertexData_position_pyramid at %d \n", __LINE__);
    }
    ...
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() failed for vertexData_position_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    ...
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() succeeded for vertexData_position_pyramid at %d \n", __LINE__);
    }
    ...
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() failed for vertexData_position_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    ...
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() succeeded for vertexData_position_pyramid at %d \n", __LINE__);
    }
    ...
    // Step 4
    memset((void*)&vertexData_color_pyramid, 0, sizeof(VertexData));
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_color_pyramid.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color for pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color for pyramid succeeded at %d \n", __LINE__);
    }

    // Step 7
    memset((void*)&vkMemoryRequirements, 0, sizeof(VkMemoryRequirements));
    vkGetBufferMemoryRequirements(vkDevice, vertexData_color_pyramid.vkBuffer, &vkMemoryRequirements);
    // No error checking
    // Step 8
    memset((void*)&vkMemoryAllocateInfo, 0, sizeof(VkMemoryAllocateInfo));
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_color_pyramid.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color for pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color for pyramid succeeded at %d \n", __LINE__);
    }

 

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_color_pyramid.vkBuffer, vertexData_color_pyramid.vkDeviceMemory, 0);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color for pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {

        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color for pyramid succeeded at %d \n", __LINE__);
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_color_pyramid.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color for pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color for pyramid succeeded at %d \n", __LINE__);
    }
    ...
    // Step 13
    vkUnmapMemory(vkDevice, vertexData_color_pyramid.vkDeviceMemory);
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() failed for vertexData_position_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() succeeded for vertexData_position_cube at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() failed for vertexData_position_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() succeeded for vertexData_position_cube at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() failed for vertexData_position_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() succeeded for vertexData_position_cube at %d \n", __LINE__);
    }
    ...
    // Vertex Color Buffer
    // Step 4
    memset((void*)&vertexData_color_cube, 0, sizeof(VertexData));
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_color_cube.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color for cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color for cube succeeded at %d \n", __LINE__);
    }

    // Step 7
    memset((void*)&vkMemoryRequirements, 0, sizeof(VkMemoryRequirements));
    vkGetBufferMemoryRequirements(vkDevice, vertexData_color_cube.vkBuffer, &vkMemoryRequirements);
    // No error checking
    // Step 8
    memset((void*)&vkMemoryAllocateInfo, 0, sizeof(VkMemoryAllocateInfo));
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_color_cube.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color for cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color for cube succeeded at %d \n", __LINE__);
    }

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_color_cube.vkBuffer, vertexData_color_cube.vkDeviceMemory, 0);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color for cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {

        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color for cube succeeded at %d \n", __LINE__);
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_color_cube.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color for cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color for cube succeeded at %d \n", __LINE__);
    }
    ...
    // Step 13
    vkUnmapMemory(vkDevice, vertexData_color_cube.vkDeviceMemory);
...
VkResult TsCreateUniformBuffer(void)
{
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkCreateBuffer() failed for uniformData_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkCreateBuffer() succeeded for uniformData_pyramid at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkAllocateMemory() failed for uniformData_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkAllocateMemory() succeeded for uniformData_pyramid at %d \n", __LINE__);
    } 
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkBindBufferMemory() failed for uniformData_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkBindBufferMemory() succeeded for uniformData_pyramid at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkCreateBuffer() failed for uniformData_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkCreateBuffer() succeeded for uniformData_cube at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkAllocateMemory() failed for uniformData_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkAllocateMemory() succeeded for uniformData_cube at %d \n", __LINE__);
    } 
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkBindBufferMemory() failed for uniformData_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkBindBufferMemory() succeeded for uniformData_cube at %d \n", __LINE__);
    }
...
VkResult TsUpdateUnifomBuffer(void)
{
    ...
    rotationMatrix = glm::rotate(
        ...
        glm::vec3(0.0f, 1.0f, 0.0f) // Across Y-Axis
    );
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsUpdateUnifomBuffer() -> Pyramid vkMapMemory() Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
...

{
 ...
 VkResult TsCreateDescriptorPool(void)
 {
    ...
    vkDescriptorPoolSize.descriptorCount = 2;  // Number of descriptor set count must be given
    ...
    vkDescriptorPoolCreateInfo.maxSets = 2; // Kiti sets pahijet = Jitke DescriptorSets aahet titke maxSets 
...
VkResult TsCreateDescriptorSet(void)
{
   ...
   // vkDescriptorSetAllocateInfo.flags = 0;
    ...
    if (VK_SUCCESS != vkTsResult)
    {
                    fprintf(gpTsFile, "[ERROR] TsCreateDescriptorSet() -> Pyramid vkAllocateDescriptorSets() failed with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
    }
    else
    {
                    fprintf(gpTsFile, "[INFO] TsCreateDescriptorSet() -> Pyramid vkAllocateDescriptorSets() succeeded at %d \n",  __LINE__);
    }
    ...
    fprintf(gpTsFile, "[INFO] Pyramid vkUpdateDescriptorSets() is run successfully!!! at %d\n", __LINE__);

    // CUBE
    vkTsResult = vkAllocateDescriptorSets(vkDevice, &vkDescriptorSetAllocateInfo, &vkDescriptorSet_cube);
    if (VK_SUCCESS != vkTsResult)
    {
                    fprintf(gpTsFile, "[ERROR] TsCreateDescriptorSet() -> Cube vkAllocateDescriptorSets() failed with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
    }
    else
    {
                    fprintf(gpTsFile, "[INFO] TsCreateDescriptorSet() -> Cube vkAllocateDescriptorSets() succeeded at %d \n",  __LINE__);
    }
    ...
    fprintf(gpTsFile, "[INFO] Cube vkUpdateDescriptorSets() is run successfully!!! at %d\n", __LINE__);
...
VkResult TsCreatePipeline(void)
{
    ...
    vkVertexInputBindingDescription_array[1].stride = sizeof(float) * 3;    // take step in 3 or 12 bytes
    ...
    vkVertexInputAttributeDescription_array[1].location = 1;    // layout(location = 1) in vec4 vColor; // in Shader.vert
...
VkResult TsBuildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        memset((void*)vkDeviceSize_offset_color, 0, sizeof(VkDeviceSize) * ARRAY_SIZE(vkDeviceSize_offset_color));

        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 
            1, // Binding Point
            1, // Number of buffer
            &vertexData_color_pyramid.vkBuffer, // Which buffer
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 
            1, // Binding Point
            1, // Number of buffer
            &vertexData_color_cube.vkBuffer, // Which buffer
            vkDeviceSize_offset_color   
        );      
