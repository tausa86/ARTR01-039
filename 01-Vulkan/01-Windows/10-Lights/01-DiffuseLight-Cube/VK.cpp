...
VkResult TsUpdateUnifomBuffer(void)
{
    ...
    // Diffuse light is white light
    // Assigning using peacemeal operations
    ...
    myuniformData.lightPosition[2] = 2.0f;  // Z
    myuniformData.lightPosition[3] = 1.0f;  // Depth 

    // Grey color
    myuniformData.materialDiffuse[0] = 0.5f;    // R
    myuniformData.materialDiffuse[1] = 0.5f;    // G
    myuniformData.materialDiffuse[2] = 0.5f;    // B
    myuniformData.materialDiffuse[3] = 1.0f;    // A    
...
VkResult TsCreatePipeline(void)
{
    ...
    // 0th index la position aahe
    // 1st index la normal aahe
    ...
    // Shader madhle attributes
     // 0th index la position aahe
    // 1st index la normal aahe
    VkVertexInputAttributeDescription vkVertexInputAttributeDescription_array[2];  // 1 means position if 2 then position, normal, color etc.
    ...
    vkVertexInputAttributeDescription_array[1].location = 1;    // layout(location = 1) in vec4 vNormal; // in Shader.vert
