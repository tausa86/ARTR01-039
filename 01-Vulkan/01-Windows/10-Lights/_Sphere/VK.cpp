...
VkResult TsInitialize(void)
{
              ...
              // Create Vulkan (Logical) device
               ...
               if(sizeof(gTsSphereNormals) > 0)
                    fprintf(gpTsFile, "[DEBUG] TsInitialize() -> getSphereVertexData() total normals: %zu\n", sizeof(gTsSphereNormals));
               else
                    fprintf(gpTsFile, "[ERROR] TsInitialize() -> getSphereVertexData() failed with %d at %d\n", vkTsResult, __LINE__);
