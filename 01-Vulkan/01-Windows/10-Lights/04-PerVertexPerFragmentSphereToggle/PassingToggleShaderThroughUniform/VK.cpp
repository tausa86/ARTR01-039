...
struct MyuniformData
{
    ...
    unsigned int perFragmentLighting; // To enable per fragment lighting
};
...
BOOL bPerFragmentLighting = TRUE; // To enable per fragment lighting
...
VkResult TsUpdateUnifomBuffer(void)
{
    ...
    if(TRUE == bPerFragmentLighting)
    {
        myuniformData.perFragmentLighting = 1;
    }
    else
    {
        myuniformData.perFragmentLighting = 0;
    }
