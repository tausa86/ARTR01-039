...
void TsUninitialize(void)
{
               ...
               if (vkDevice)
               {
                              ...
                              /*// Free swapchain images use case 4 Swapchain images la vkDestroyImage() use karaych nahi
                              for(uint32_t i = 0; i < swapchainImageCount; i++)
                              {
                                             ...
                                             fflush(gpTsFile);
                                             // if needed close gpTsFile handle here to get the validation error for use case 4
                              }*/
