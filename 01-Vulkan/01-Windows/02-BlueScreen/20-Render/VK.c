...
VkResult TsCreateFrameBuffers(void)
{
               ...
               vkFramebufferCreateInfo.layers = 1; // Composite layers in Vulkan allowed are 256 guranteed width = 4096 and height = 4096 i.e. 4K images. Desktop quality rendered supports 16K images & 2048 layers
