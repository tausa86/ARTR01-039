...
VkResult TsInitialize(void)
{
              ...
              // Create Vulkan (Logical) device
               ...
               // Texture creation
               vkTsResult = TsCreateTexture("Vijay_Kundali.png");
               if (VK_SUCCESS != vkTsResult)
               {
                    fflush(gpTsFile);
                    fprintf(gpTsFile, "[ERROR] TsInitialize() -> TsCreateTexture() failed for Vijay_Kundali.png with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
               }
               else
               {
                    fprintf(gpTsFile, "[INFO] TsInitialize() -> TsCreateTexture() succeeded for Vijay_Kundali.png at %d \n", __LINE__);
               }
