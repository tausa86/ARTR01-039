...
VertexData vertexData_texcord_pyramid;
VertexData vertexData_position_cube;
VertexData vertexData_texcord_cube;
...
VkDescriptorSet vkDescriptorSet_pyramid = VK_NULL_HANDLE;   // Descriptor Set
VkDescriptorSet vkDescriptorSet_cube = VK_NULL_HANDLE;   // Descriptor Set
...
VkResult TsInitialize(void)
{
               ...
               VkResult TsCreateTexturePyramid(const char *);
               VkResult TsCreateTextureCube(const char *);
              ...
              // Create Vulkan (Logical) device
               ...
               // Texture creation
               vkTsResult = TsCreateTexturePyramid("Stone.png");
               if (VK_SUCCESS != vkTsResult)
               {
                    fflush(gpTsFile);
                    fprintf(gpTsFile, "[ERROR] TsInitialize() -> TsCreateTexturePyramid() failed for Stone.png with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
               }
               else
               {
                    fprintf(gpTsFile, "[INFO] TsInitialize() -> TsCreateTexturePyramid() succeeded for Stone.png at %d \n", __LINE__);
               }

               vkTsResult = TsCreateTextureCube("Vijay_Kundali.png");
               if (VK_SUCCESS != vkTsResult)
               {
                    fflush(gpTsFile);
                    fprintf(gpTsFile, "[ERROR] TsInitialize() -> TsCreateTextureCube() failed for Vijay_Kundali.png with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
               }
               else
               {
                    fprintf(gpTsFile, "[INFO] TsInitialize() -> TsCreateTextureCube() succeeded for Vijay_Kundali.png at %d \n", __LINE__);
               }
...
void TsUninitialize(void)
{
               ...
               if (vkDevice)
               {
                              ...
                              if(uniformData_cube.vkBuffer)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done for uniformData_cube.vkBuffer\n");
                              }
                              ...
                              if(uniformData_cube.vkDeviceMemory)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for uniformData_cube.vkDeviceMemory\n");
                              }
                              ...
                              if(uniformData_pyramid.vkBuffer)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done for uniformData_pyramid.vkBuffer\n");
                              }
                              ...
                              if(uniformData_pyramid.vkDeviceMemory)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for uniformData_pyramid.vkDeviceMemory\n");
                              }
                              ...
                              if(vkSampler_texture_cube)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroySampler() is successfully done for vkSampler_texture_cube\n");
                              }
                              ...
                              if(vkSampler_texture_pyramid)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroySampler() is successfully done for vkSampler_texture_pyramid\n");
                              }
                               ...
                               if(vkDeviceMemory_texture_cube)
                                {
                                    ...
                                    fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for vkDeviceMemory_texture_cube\n");
                                }
                              ...
                              if(vkDeviceMemory_texture_pyramid)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for vkDeviceMemory_texture_pyramid\n");
                              }
                              ...
                              if(vkImage_texture_cube)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyImage() is successfully done for vkImage_texture_cube\n");
                              }
                              ...
                              if(vkImage_texture_pyramid)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyImage() is successfully done for vkImage_texture_pyramid\n");
                              }

                              // [STEP-34] Free Texcoord Buffer
                              if(vertexData_texcord_cube.vkDeviceMemory)
                              {
                                vkFreeMemory(vkDevice, vertexData_texcord_cube.vkDeviceMemory, NULL);
                                vertexData_texcord_cube.vkDeviceMemory = VK_NULL_HANDLE;
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() for vertexData_texcord_cube is successfully done\n");
                              }

                              if(vertexData_texcord_cube.vkBuffer)
                              {
                                vkDestroyBuffer(vkDevice, vertexData_texcord_cube.vkBuffer, NULL);
                                vertexData_texcord_cube.vkBuffer = VK_NULL_HANDLE;
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() for vertexData_texcord_cube is successfully done\n");
                              }

                              if(vertexData_texcord_pyramid.vkDeviceMemory)
                              {
                                vkFreeMemory(vkDevice, vertexData_texcord_pyramid.vkDeviceMemory, NULL);
                                vertexData_texcord_pyramid.vkDeviceMemory = VK_NULL_HANDLE;
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() for vertexData_texcord_pyramid is successfully done\n");
                              }

                              if(vertexData_texcord_pyramid.vkBuffer)
                              {
                                vkDestroyBuffer(vkDevice, vertexData_texcord_pyramid.vkBuffer, NULL);
                                vertexData_texcord_pyramid.vkBuffer = VK_NULL_HANDLE;
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() for vertexData_texcord_pyramid is successfully done\n");
                              }
                              ...
                              if(vertexData_position_cube.vkDeviceMemory)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done vertexData_position_cube\n");
                              }
                              ...
                              if(vertexData_position_cube.vkBuffer)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done vertexData_position_cube\n");
                              }
                              ...
                              if(vertexData_position_pyramid.vkDeviceMemory)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done vertexData_position_pyramid\n");
                              }
                              ...
                              if(vertexData_position_pyramid.vkBuffer)
                              {
                                ...
                                fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done vertexData_position_pyramid\n");
                              }
               ...
               // No need to destroy vkQueue as it is not created by us, it is created by vkCreateDevice() function
               ...
               if (NULL != gpTsFile)
               {
                    ...
                    free(gpTsFile);
                    gpTsFile = NULL;
                    fprintf(gpTsFile, "[INFO] TsUninitialize() -> gpTsFile is successfully freed\n");
               }               
}
...
float pyramidTexcoords[] =
{
    ...
    vkBufferCreateInfo.size = sizeof(pyramidPosition);
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_position_pyramid.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() failed for vertexData_position_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() succeeded for vertexData_position_pyramid at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_position_pyramid.vkDeviceMemory);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() vertexData_position_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() vertexData_position_pyramid succeeded at %d \n", __LINE__);
    }

     // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_position_pyramid.vkBuffer, vertexData_position_pyramid.vkDeviceMemory, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() vertexData_position_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() vertexData_position_pyramid succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_position_pyramid.vkDeviceMemory, //
        0, // start
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() vertexData_position_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() vertexData_position_pyramid succeeded at %d \n", __LINE__);
    }

    // Step 12
    memcpy(data, pyramidPosition, sizeof(pyramidPosition));
    ...
    // Step 4
    memset((void*)&vertexData_texcord_pyramid, 0, sizeof(VertexData));
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_texcord_pyramid.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_texcord_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_texcord_pyramid succeeded at %d \n", __LINE__);
    }

    // Step 7
    memset((void*)&vkMemoryRequirements, 0, sizeof(VkMemoryRequirements));
    vkGetBufferMemoryRequirements(vkDevice, vertexData_texcord_pyramid.vkBuffer, &vkMemoryRequirements);
    // No error checking
    // Step 8
    memset((void*)&vkMemoryAllocateInfo, 0, sizeof(VkMemoryAllocateInfo));
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_texcord_pyramid.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_texcord_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_texcord_pyramid succeeded at %d \n", __LINE__);
    }

 

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_texcord_pyramid.vkBuffer, vertexData_texcord_pyramid.vkDeviceMemory, 0);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_texcord_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_texcord_pyramid succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_texcord_pyramid.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_texcord_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_texcord_pyramid succeeded at %d \n", __LINE__);
    }
    ...
    // Step 13
    vkUnmapMemory(vkDevice, vertexData_texcord_pyramid.vkDeviceMemory);
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_position_cube.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() failed for vertexData_position_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() succeeded for vertexData_position_cube at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_position_cube.vkDeviceMemory);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() vertexData_position_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() vertexData_position_cube succeeded at %d \n", __LINE__);
    }

     // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_position_cube.vkBuffer, vertexData_position_cube.vkDeviceMemory, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() vertexData_position_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() vertexData_position_cube succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_position_cube.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() vertexData_position_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() vertexData_position_cube succeeded at %d \n", __LINE__);
    }
    ...
    // Vertex Texcoord Buffer
    // Step 4
    memset((void*)&vertexData_texcord_cube, 0, sizeof(VertexData));
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_texcord_cube.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_texcord_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_texcord_cube succeeded at %d \n", __LINE__);
    }

    // Step 7
    memset((void*)&vkMemoryRequirements, 0, sizeof(VkMemoryRequirements));
    vkGetBufferMemoryRequirements(vkDevice, vertexData_texcord_cube.vkBuffer, &vkMemoryRequirements);
    // No error checking
    // Step 8
    memset((void*)&vkMemoryAllocateInfo, 0, sizeof(VkMemoryAllocateInfo));
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_texcord_cube.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_texcord_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_texcord_cube succeeded at %d \n", __LINE__);
    } 

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_texcord_cube.vkBuffer, vertexData_texcord_cube.vkDeviceMemory, 0);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_texcord_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_texcord_cube succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_texcord_cube.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_texcord_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_texcord_cube succeeded at %d \n", __LINE__);
    }
    ...
    // Step 13
    vkUnmapMemory(vkDevice, vertexData_texcord_cube.vkDeviceMemory);

    return(vkTsResult);
}

// Texture creation
VkResult TsCreateTexturePyramid(const char * textureFileName)
{
    // Local variable declaration
    VkResult vkTsResult = VK_SUCCESS;
    ...
    vkTsResult = vkCreateImage(vkDevice, &vkImageCreateInfo, NULL, &vkImage_texture_pyramid);
    if (VK_SUCCESS != vkTsResult)
    {
    ...
    vkGetImageMemoryRequirements(vkDevice, vkImage_texture_pyramid, &vkMemoryRequirements_image);
    ...
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo_image, NULL, &vkDeviceMemory_texture_pyramid);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTexture() -> vkAllocateMemory() failed for vkDeviceMemory_texture_pyramid at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTexture() -> vkAllocateMemory() succeeded for vkDeviceMemory_texture_pyramid at %d \n", __LINE__);
    } 

    vkTsResult = vkBindImageMemory(vkDevice, vkImage_texture_pyramid, vkDeviceMemory_texture_pyramid, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTexture() -> vkBindImageMemory() for pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTexture() -> vkBindImageMemory() for pyramid succeeded at %d \n", __LINE__);
    }
    ...
    vkImageMemoryBarrier.image = vkImage_texture_pyramid;
    ...
    vkCmdCopyBufferToImage(vkCommandBuffer_buffer_to_image_copy, vkBuffer_staging_buffer, vkImage_texture_pyramid, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &vkBufferImageCopy);
    ...
    vkImageViewCreateInfo.viewType = VK_IMAGE_VIEW_TYPE_2D;   // VkImageViewType enum cha member aahe
    vkImageViewCreateInfo.image = vkImage_texture_pyramid; // Texture image created above

    vkTsResult = vkCreateImageView(vkDevice, &vkImageViewCreateInfo, NULL, &vkImageView_texture_pyramid);
    if (VK_SUCCESS != vkTsResult)
    {
    ...
    vkTsResult = vkCreateSampler(vkDevice, &vkSamplerCreateInfo, NULL, &vkSampler_texture_pyramid);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTexture() -> vkCreateSampler() for buffer copy image for pyramid failed with %d at %d\n", vkTsResult, __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTexture() -> vkCreateSampler() for buffer copy image for pyramid succeeded at %d \n", __LINE__);
    }

    return(vkTsResult);
}

VkResult TsCreateTextureCube(const char * textureFileName)
{
    // Local variable declaration
    VkResult vkTsResult = VK_SUCCESS;
    ...
    {
        fflush(gpTsFile);
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> fopen() failed for %s at %d \n", textureFileName, __LINE__);
        vkTsResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkTsResult);
    }
    ...
    stbi_set_flip_vertically_on_load(1); // 1 for true

    image_data = stbi_load_from_file(fp, &texture_width, &texture_height, &texture_channels, STBI_rgb_alpha);
    if(NULL == image_data || texture_width <= 0 || texture_height <= 0 || texture_channels <= 0)
    {
        fflush(gpTsFile);
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> stbi_load_from_file() failed to get image info at %d \n", __LINE__);
        vkTsResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkTsResult);
    }    
    ...
    {
        fflush(gpTsFile);
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkCreateBuffer() for vkBufferCreateInfo_staging_buffer failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkCreateBuffer() for vkBufferCreateInfo_staging_buffer succeeded at %d \n", __LINE__);
    }
    ...
    {
        fflush(gpTsFile);
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkAllocateMemory() for vkDeviceMemory_staging_buffer failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkAllocateMemory() for vkDeviceMemory_staging_buffer succeeded at %d \n", __LINE__);
    }
    ...
    {
        fflush(gpTsFile);
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkBindBufferMemory() for vkDeviceMemory_staging_buffer failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkBindBufferMemory() for vkDeviceMemory_staging_buffer succeeded at %d \n", __LINE__);
    }
    ...
    {
        fflush(gpTsFile);
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkMapMemory() for vkDeviceMemory_staging_buffer failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkMapMemory() for vkDeviceMemory_staging_buffer succeeded at %d \n", __LINE__);
    }
    ...
    stbi_image_free(image_data);
    image_data = NULL;
    fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> stbi_image_free() free of image is succeeded at %d \n", __LINE__);
    ...
    vkTsResult = vkCreateImage(vkDevice, &vkImageCreateInfo, NULL, &vkImage_texture_cube);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkCreateImage() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkCreateImage() succeeded at %d \n", __LINE__);
    }

    VkMemoryRequirements vkMemoryRequirements_image;
    memset((void *)&vkMemoryRequirements_image, 0, sizeof(VkMemoryRequirements));
    vkGetImageMemoryRequirements(vkDevice, vkImage_texture_cube, &vkMemoryRequirements_image);
    ...
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo_image, NULL, &vkDeviceMemory_texture_cube);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkAllocateMemory() failed for vkDeviceMemory_texture_cube at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkAllocateMemory() succeeded for vkDeviceMemory_texture_cube at %d \n", __LINE__);
    } 

    vkTsResult = vkBindImageMemory(vkDevice, vkImage_texture_cube, vkDeviceMemory_texture_cube, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkBindImageMemory() for cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkBindImageMemory() for cube succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkAllocateCommandBuffers() failed to 'Command Copy' at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkAllocateCommandBuffers() succeeded to 'Command Copy' at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkBeginCommandBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkBeginCommandBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    vkImageMemoryBarrier.srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
    vkImageMemoryBarrier.dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED;
    vkImageMemoryBarrier.image = vkImage_texture_cube;
    vkImageMemoryBarrier.subresourceRange.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
    vkImageMemoryBarrier.subresourceRange.baseArrayLayer = 0;    // 0th index
    vkImageMemoryBarrier.subresourceRange.baseMipLevel = 0;  // 0th Index
    vkImageMemoryBarrier.subresourceRange.layerCount = 1;
    ...
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() unsupported texture layout transition at %d !!!\n", __LINE__);
        vkTsResult = VK_ERROR_INITIALIZATION_FAILED;
        return(vkTsResult);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkEndCommandBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkEndCommandBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkQueueSubmit() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkQueueSubmit() succeeded at %d \n", __LINE__);
    }

    vkTsResult = vkQueueWaitIdle(vkQueue);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkQueueWaitIdle() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkQueueWaitIdle() succeeded at %d \n", __LINE__);
    }
    ...
    if(vkCommandBuffer_transition_image_layout)
    {
        vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_transition_image_layout);
        vkCommandBuffer_transition_image_layout = NULL;
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkFreeCommandBuffers() succeeded for vkCommandBuffer_transition_image_layout at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkAllocateCommandBuffers() failed to buffer to image copy at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkAllocateCommandBuffers() succeeded to 'buffer to image Copy' at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkBeginCommandBuffer() for buffer to image copy failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkBeginCommandBuffer() succeeded for buffer to image copy at %d \n", __LINE__);
    }
    ...
    vkCmdCopyBufferToImage(vkCommandBuffer_buffer_to_image_copy, vkBuffer_staging_buffer, vkImage_texture_cube, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &vkBufferImageCopy);

    vkTsResult = vkEndCommandBuffer(vkCommandBuffer_buffer_to_image_copy);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkEndCommandBuffer() for vkCommandBuffer_buffer_to_image_copy failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkEndCommandBuffer() succeeded for vkCommandBuffer_buffer_to_image_copy at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkQueueSubmit() failed for vkCommandBuffer_buffer_to_image_copy at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkQueueSubmit() succeeded for vkCommandBuffer_buffer_to_image_copy at %d \n", __LINE__);
    }

    vkTsResult = vkQueueWaitIdle(vkQueue);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkQueueWaitIdle() failed for vkCommandBuffer_buffer_to_image_copy at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkQueueWaitIdle() succeeded for vkCommandBuffer_buffer_to_image_copy at %d \n", __LINE__);
    }
    ...
    if(vkCommandBuffer_buffer_to_image_copy)
    {
        vkFreeCommandBuffers(vkDevice, vkCommandPool, 1, &vkCommandBuffer_buffer_to_image_copy);
        vkCommandBuffer_buffer_to_image_copy = NULL;
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkFreeCommandBuffers() succeeded for vkCommandBuffer_buffer_to_image_copy at %d \n", __LINE__);
    }
    ...
    if(vkDeviceMemory_staging_buffer)
    {
        vkFreeMemory(vkDevice, vkDeviceMemory_staging_buffer, NULL);
        vkDeviceMemory_staging_buffer = VK_NULL_HANDLE;
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> [Buffer Copy] vkFreeMemory() vkDeviceMemory_staging_buffer succeeded at %d \n", __LINE__);
    }
    ...
    if(vkBuffer_staging_buffer)
    {
        vkDestroyBuffer(vkDevice, vkBuffer_staging_buffer, NULL);
        vkBuffer_staging_buffer = VK_NULL_HANDLE;
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> [Buffer Copy] vkDestroyBuffer() vkBuffer_staging_buffer succeeded at %d \n", __LINE__);
    }
    ...
    vkImageViewCreateInfo.viewType = VK_IMAGE_VIEW_TYPE_2D;   // VkImageViewType enum cha member aahe
    vkImageViewCreateInfo.image = vkImage_texture_cube; // Texture image created above

    vkTsResult = vkCreateImageView(vkDevice, &vkImageViewCreateInfo, NULL, &vkImageView_texture_cube);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkCreateImageView() for buffer copy image failed with %d at %d\n", vkTsResult, __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkCreateImageView() for buffer copy image succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkCreateSampler(vkDevice, &vkSamplerCreateInfo, NULL, &vkSampler_texture_cube);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateTextureCube() -> vkCreateSampler() for buffer copy image for cube failed with %d at %d\n", vkTsResult, __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateTextureCube() -> vkCreateSampler() for buffer copy image for cube succeeded at %d \n", __LINE__);
    }
...
VkResult TsCreateUniformBuffer(void)
{
    ...
    // Step 6
    // PYRAMID
    memset((void *)&uniformData_pyramid, 0, sizeof(uniformData_pyramid));
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &uniformData_pyramid.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkCreateBuffer() uniformData_pyramid failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkCreateBuffer() uniformData_pyramid succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &uniformData_pyramid.vkDeviceMemory);
    ...
    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, uniformData_pyramid.vkBuffer, uniformData_pyramid.vkDeviceMemory, 0);
    if (VK_SUCCESS != vkTsResult)
    {
    ...
    // CUBE
    memset((void *)&uniformData_cube, 0, sizeof(uniformData_cube));
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &uniformData_cube.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkCreateBuffer() uniformData_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkCreateBuffer() uniformData_cube succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &uniformData_cube.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkAllocateMemory() uniformData_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkAllocateMemory() uniformData_cube succeeded at %d \n", __LINE__);
    } 

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, uniformData_cube.vkBuffer, uniformData_cube.vkDeviceMemory, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> vkBindBufferMemory() uniformData_cube failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> vkBindBufferMemory() uniformData_cube succeeded at %d \n", __LINE__);
    }
...
VkResult TsUpdateUnifomBuffer(void)
{
    ...
    translationMatrix = glm::translate(
        ...
        glm::vec3(-1.5f, 0.0f, -6.0f)    // Translation Vector x, y, z
    );
    glm::mat4 rotationMatrix = glm::mat4(1.0);  // Identity Matrix
    rotationMatrix = glm::rotate(
        glm::mat4(1.0f),    // Identity Matrix Transform matrix
        glm::radians(angle),    // Angle in radians
        glm::vec3(0.0f, 1.0f, 0.0f)    // Rotation across Axis y
    );

    myuniformData.modelMatrix = translationMatrix * rotationMatrix; // Model Matrix = Translation Matrix * Rotation Matrix
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        uniformData_pyramid.vkDeviceMemory, 
        0,
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsUpdateUnifomBuffer() -> vkMapMemory() uniformData_pyramid Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    ...
    memset((void *)&myuniformData, 0, sizeof(MyuniformData));
     ...
     // Update matrices
    myuniformData.modelMatrix = glm::mat4(1.0); // Identity Matrix
    translationMatrix = glm::mat4(1.0);   // Identity Matrix
    translationMatrix = glm::translate(
        glm::mat4(1.0),    // Identity Matrix Transform matrix
        glm::vec3(1.5f, 0.0f, -6.0f)     // Translation Vector across Z-axis
    );
    ...
    rotationMatrix = glm::mat4(1.0);   // Identity Matrix
    ...
    perspectiveProjectionMatrix = glm::mat4(1.0);    // Identity Matrix
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        uniformData_cube.vkDeviceMemory, 
        0,
        sizeof(MyuniformData),
        0,
        &data
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsUpdateUnifomBuffer() -> Cube vkMapMemory() Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
...
VkResult TsCreateShaders(void)
{
    ...
    fflush(gpTsFile);
    fprintf(gpTsFile, "[INFO] TsCreateShaders() -> Fragment Shader Module is successfully created!!!at %d\n", __LINE__);
...
VkResult TsCreateDescriptorSet(void)
{
    ...
    vkTsResult = vkAllocateDescriptorSets(vkDevice, &vkDescriptorSetAllocateInfo, &vkDescriptorSet_pyramid);
    if (VK_SUCCESS != vkTsResult)
    {
                    fprintf(gpTsFile, "[ERROR] TsCreateDescriptorSet() -> vkAllocateDescriptorSets() vkDescriptorSet_pyramid failed with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
    }
    else
    {
                    fprintf(gpTsFile, "[INFO] TsCreateDescriptorSet() -> vkAllocateDescriptorSets() vkDescriptorSet_pyramid succeeded at %d \n",  __LINE__);
    }
    ...
    fprintf(gpTsFile, "[INFO] For pyramid vkUpdateDescriptorSets() is run successfully!!! at %d\n", __LINE__);
    ...
    vkTsResult = vkAllocateDescriptorSets(vkDevice, &vkDescriptorSetAllocateInfo, &vkDescriptorSet_cube);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateDescriptorSet() -> vkAllocateDescriptorSets() vkDescriptorSet_cube failed with %d at %d\n", vkTsResult, __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateDescriptorSet() -> vkAllocateDescriptorSets() vkDescriptorSet_cube succeeded at %d \n",  __LINE__);
    }
    ...
    vkUpdateDescriptorSets(vkDevice, ARRAY_SIZE(vkWriteDescriptorSet_array), vkWriteDescriptorSet_array, 0, NULL);    // No error checking
    fprintf(gpTsFile, "[INFO] For cube vkUpdateDescriptorSets() is run successfully!!! at %d\n", __LINE__);
...
VkResult TsBuildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdBindDescriptorSets(vkCommandBuffer_array[i], VK_PIPELINE_BIND_POINT_GRAPHICS, vkPipelineLayout, 0, 1, &vkDescriptorSet_pyramid, 0, NULL);
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 0, 1, &vertexData_position_pyramid.vkBuffer, vkDeviceSize_offset_position);
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 
            1, // Binding Point
            1, // Number of buffer
            &vertexData_texcord_pyramid.vkBuffer, // Which buffer
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 0, 1, &vertexData_position_cube.vkBuffer, vkDeviceSize_offset_array);
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 
            1, // Binding Point
            1, // Number of buffer
            &vertexData_texcord_cube.vkBuffer, // Which buffer
            vkDeviceSize_offset_texcoords   
        );      
