...
VkResult TsUpdateUnifomBuffer(void)
{
    ...
    glm::mat4 orthographicProjectionMatrix = glm::mat4(1.0);    // Identity Matrix
    ...
    if(winWidth <= winHeight)
    {
        orthographicProjectionMatrix = glm::ortho(
            -100.0f,    // Left
            100.0f,     // Right
            -100.0f * ((float)winHeight / (float)winWidth), // Bottom
            100.0f * ((float)winHeight / (float)winWidth),  // Top
            -100.0f,    // Near
            100.0f      // Far
        );
    }
    ...
    {
         orthographicProjectionMatrix = glm::ortho(            
            -100.0f * ((float)winWidth / (float)winHeight), // Right
            100.0f * ((float)winWidth / (float)winHeight),  // Left
            -100.0f,    // Bottom
            100.0f,     // Top
            -100.0f,    // Near
            100.0f      // Far
