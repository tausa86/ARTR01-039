...

{
    ...
    // Konta color write karaych aahe and 0xf = RGBA enabled i.e. show all colors

    vkPipelineColorBlendAttachmentState_array[0].colorWriteMask = 0xf;  // No validation error if not given and drawing will also not come if this is not given
