...
VkResult TsCreateImagesAndImageViews(void)
{
               ...
               // VK_FORMAT_B8G8R8A8_UNORM is replaced by vkFormat_color to remove validation error VUID-VkFramebufferCreateInfo-pAttachements-00880
               // has format VK_FORMAT_B8G8R8A8_UNORM that does not match with the format of VK_FORMAT_R8G8B8A8_UNORM used by the corresponding
               // attachment for VkRenderPass
