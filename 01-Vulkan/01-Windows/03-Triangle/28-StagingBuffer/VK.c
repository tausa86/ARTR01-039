...
// [STEP-22] create vertex buffer with staging
VkResult TsCreateVertexBuffer(void)
{
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Staging Buffer] vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Staging Buffer] vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Staging Buffer] vkAllocateMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Staging Buffer] vkAllocateMemory() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Staging Buffer] vkBindBufferMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Staging Buffer] vkBindBufferMemory() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Staging Buffer] vkMapMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Staging Buffer] vkMapMemory() succeeded at %d \n", __LINE__);
    }
    ...
    vkBufferCreateInfo.usage = VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;    // Data Transfer Destination Buffer
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Vertex Buffer] vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Vertex Buffer] vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    for(uint32_t i = 0; i < vkPhysicalDeviceMemoryProperties.memoryTypeCount; i++)
    {
        ...
        {
            // Step c
            if(vkPhysicalDeviceMemoryProperties.memoryTypes[i].propertyFlags & VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT) // Only visible to device
            {
                // Step d
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Vertex Buffer] vkAllocateMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Vertex Buffer] vkAllocateMemory() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Vertex Buffer] vkBindBufferMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Vertex Buffer] vkBindBufferMemory() succeeded at %d \n", __LINE__);
    }

    // No need to vkMapMemory(), memcpy() and vkUnmapMemory() for this device visible buffer
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateCommandBuffers() failed to 'Command Copy' at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateCommandBuffers() succeeded to 'Command Copy' at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBeginCommandBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBeginCommandBuffer() succeeded at %d \n", __LINE__);
    }

    VkBufferCopy vkBufferCopy;
    memset((void *)&vkBufferCopy, 0, sizeof(vkBufferCopy));

    //vkBufferCopy.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Buffer Copy] vkEndCommandBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Buffer Copy] vkEndCommandBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Buffer Copy] vkQueueSubmit() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Buffer Copy] vkQueueSubmit() succeeded at %d \n", __LINE__);
    }
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> [Buffer Copy] vkQueueWaitIdle() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Buffer Copy] vkQueueWaitIdle() succeeded at %d \n", __LINE__);
    }
    ...
    if(vkCommandBuffer)
    {
        ...
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Buffer Copy] vkFreeCommandBuffers() succeeded at %d \n", __LINE__);
    }
    ...
    if(vertexData_stagingBuffer_position.vkDeviceMemory)
    {
        ...
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Buffer Copy] vkFreeMemory() vertexData_stagingBuffer_position.vkDeviceMemory succeeded at %d \n", __LINE__);
    }
    ...
    if(vertexData_stagingBuffer_position.vkBuffer)
    {
        ...
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> [Buffer Copy] vkDestroyBuffer() vertexData_stagingBuffer_position.vkBuffer succeeded at %d \n", __LINE__);
    }
