...
VkDescriptorSet vkDescriptorSet_triangle = VK_NULL_HANDLE;   // Descriptor Set
...
void TsUninitialize(void)
{
               ...
               if (vkDevice)
               {
                    ...
                    if(uniformData_rectangle.vkBuffer)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> Rectangle vkDestroyBuffer() is successfully done for uniformData_rectangle.vkBuffer\n");
                    }
                    ...
                    if(uniformData_rectangle.vkDeviceMemory)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> Rectangle vkFreeMemory() is successfully done for uniformData_rectangle.vkDeviceMemory\n");
                    }
                    ...
                    if(uniformData_triangle.vkBuffer)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() is successfully done for uniformData_triangle.vkBuffer\n");
                    }
                    ...
                    if(uniformData_triangle.vkDeviceMemory)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() is successfully done for uniformData_triangle.vkDeviceMemory\n");
                    }
                    ...
                    if(vertexData_color_rectangle.vkDeviceMemory)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() for vertexData_color_rectangle is successfully done\n");
                    }
                    ...
                    if(vertexData_color_rectangle.vkBuffer)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() for vertexData_color_rectangle is successfully done\n");
                    }
                    ...
                    if(vertexData_position_rectangle.vkDeviceMemory)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vertexData_position_rectangle vkFreeMemory() is successfully done\n");
                    }
                    ...
                    if(vertexData_position_rectangle.vkBuffer)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vertexData_position_rectangle vkDestroyBuffer() is successfully done\n");
                    }
                    ...
                    if(vertexData_color_triangle.vkDeviceMemory)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkFreeMemory() for vertexData_color_triangle is successfully done\n");
                    }
                    ...
                    if(vertexData_color_triangle.vkBuffer)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vkDestroyBuffer() for vertexData_color_triangle is successfully done\n");
                    }
                    ...
                    if(vertexData_position_triangle.vkDeviceMemory)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vertexData_position_triangle vkFreeMemory() is successfully done\n");
                    }
                    ...
                    if(vertexData_position_triangle.vkBuffer)
                    {
                        ...
                        fprintf(gpTsFile, "[INFO] TsUninitialize() -> vertexData_position_triangle vkDestroyBuffer() is successfully done\n");
                    }
...
VkResult TsCreateVertexBuffer(void)
{
    ...
    // As there is no Quad topology we have draw rectangle using 2 triangles with Traingle-List Topology
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_position_triangle.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Triangle vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> Triangle vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_position_triangle.vkDeviceMemory);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Triangle vkAllocateMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> Triangle vkAllocateMemory() succeeded at %d \n", __LINE__);
    }

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_position_triangle.vkBuffer, vertexData_position_triangle.vkDeviceMemory, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Triangle vkBindBufferMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> Triangle vkBindBufferMemory() succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_position_triangle.vkDeviceMemory, //
        0, // start
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Triangle vkMapMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> Triangle vkMapMemory() succeeded at %d \n", __LINE__);
    }
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_color_triangle.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color_triangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color_triangle succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_color_triangle.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color_triangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color_triangle succeeded at %d \n", __LINE__);
    } 

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_color_triangle.vkBuffer, vertexData_color_triangle.vkDeviceMemory, 0);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color_triangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {

        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color_triangle succeeded at %d \n", __LINE__);
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_color_triangle.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color_triangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color_triangle succeeded at %d \n", __LINE__);
    }
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_position_rectangle.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Rectangle vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> Rectangle vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_position_rectangle.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Rectangle vkAllocateMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> Rectangle vkAllocateMemory() succeeded at %d \n", __LINE__);
    }

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_position_rectangle.vkBuffer, vertexData_position_rectangle.vkDeviceMemory, 0);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Rectangle vkBindBufferMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() ->Rectangle vkBindBufferMemory() succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_position_rectangle.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> Rectangle vkMapMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> Rectangle vkMapMemory() succeeded at %d \n", __LINE__);
    }
    ...
    // Step 6
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &vertexData_color_rectangle.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color_rectangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkCreateBuffer() for vertexData_color_rectangle succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &vertexData_color_rectangle.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color_rectangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkAllocateMemory() for vertexData_color_rectangle succeeded at %d \n", __LINE__);
    }
 
    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, vertexData_color_rectangle.vkBuffer, vertexData_color_rectangle.vkDeviceMemory, 0);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color_rectangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkBindBufferMemory() for vertexData_color_rectangle succeeded at %d \n", __LINE__);
    }
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        vertexData_color_rectangle.vkDeviceMemory, //
        0, // start
        vkMemoryAllocateInfo.allocationSize, // sizeof
        0, // Reserved
        &data
    ...
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color_rectangle failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateVertexBuffer() -> vkMapMemory() for vertexData_color_rectangle succeeded at %d \n", __LINE__);
    }
...
VkResult TsCreateUniformBuffer(void)
{
    ...
    // Triangle
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &uniformData_triangle.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> Triangle vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> Triangle vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &uniformData_triangle.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> Triangle vkAllocateMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> Triangle vkAllocateMemory() succeeded at %d \n", __LINE__);
    } 

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, uniformData_triangle.vkBuffer, uniformData_triangle.vkDeviceMemory, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> Triangle vkBindBufferMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> Triangle vkBindBufferMemory() succeeded at %d \n", __LINE__);
    }

    // Rectangle
    memset((void *)&uniformData_rectangle, 0, sizeof(UniformData));
    vkTsResult = vkCreateBuffer(vkDevice, &vkBufferCreateInfo, NULL, &uniformData_rectangle.vkBuffer);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> Rectangle vkCreateBuffer() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> Rectangle vkCreateBuffer() succeeded at %d \n", __LINE__);
    }
    ...
    // Step 9
    vkTsResult = vkAllocateMemory(vkDevice, &vkMemoryAllocateInfo, NULL, &uniformData_rectangle.vkDeviceMemory);

    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> Rectangle vkAllocateMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> Rectangle vkAllocateMemory() succeeded at %d \n", __LINE__);
    } 

    // Step 10 it binds vulkan device buffer object handle with vulkan device memory object handle
    vkTsResult = vkBindBufferMemory(vkDevice, uniformData_rectangle.vkBuffer, uniformData_rectangle.vkDeviceMemory, 0);
    if (VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsCreateUniformBuffer() -> Rectangle vkBindBufferMemory() failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    else
    {
        fprintf(gpTsFile, "[INFO] TsCreateUniformBuffer() -> Rectangle vkBindBufferMemory() succeeded at %d \n", __LINE__);
    }
...
VkResult TsUpdateUnifomBuffer(void)
{
    ...
    rotationMatrix = glm::rotate(
        ...
        glm::radians(angle),    // Rotation Angle in Radians
        glm::vec3(0.0f, 1.0f, 0.0f) // Rotate across Y-Axis
    );
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        uniformData_triangle.vkDeviceMemory, 
        0,
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsUpdateUnifomBuffer() -> Triangle vkMapMemory() Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
    ...
    rotationMatrix = glm::rotate(
        glm::mat4(1.0), // Identity Matrix
        glm::radians(angle),    // Angle of rotation in radians
        glm::vec3(1.0f, 0.0f, 0.0f) // rotation (x,y,z) across X-Axis 
    );
    ...
    vkTsResult = vkMapMemory(
        vkDevice,
        uniformData_rectangle.vkDeviceMemory, 
        0,
        sizeof(MyuniformData),
        0,
        &data
    ...
    if(VK_SUCCESS != vkTsResult)
    {
        fprintf(gpTsFile, "[ERROR] TsUpdateUnifomBuffer() -> Rectangle vkMapMemory() Failed at %d\n", __LINE__);
        return(vkTsResult);
    }
...
VkResult TsCreatePipelineLayout(void)
{
 ...
 VkResult TsCreateDescriptorPool(void)
 {
    ...
    vkDescriptorPoolSize.descriptorCount = 2;   // Number of descriptor set count
...
VkResult TsCreateDescriptorSet(void)
{
   ...
   // vkDescriptorSetAllocateInfo.flags = 0;
    ...
    vkTsResult = vkAllocateDescriptorSets(vkDevice, &vkDescriptorSetAllocateInfo, &vkDescriptorSet_triangle);
    if (VK_SUCCESS != vkTsResult)
    {
                    fprintf(gpTsFile, "[ERROR] TsCreateDescriptorSet() -> Triangle vkAllocateDescriptorSets() failed with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
    }
    else
    {
                    fprintf(gpTsFile, "[INFO] TsCreateDescriptorSet() -> Triangle vkAllocateDescriptorSets() succeeded at %d \n",  __LINE__);
    }
    ...
    fprintf(gpTsFile, "[INFO] Triangle vkUpdateDescriptorSets() is run successfully!!! at %d\n", __LINE__);

    // RECTANGLE
    // Describe whether buffer as uniform or image as uniform
    vkTsResult = vkAllocateDescriptorSets(vkDevice, &vkDescriptorSetAllocateInfo, &vkDescriptorSet_rectangle);
    if (VK_SUCCESS != vkTsResult)
    {
                    fprintf(gpTsFile, "[ERROR] TsCreateDescriptorSet() -> Rectangle vkAllocateDescriptorSets() failed with %d at %d\n", vkTsResult, __LINE__);
                    return(vkTsResult);
    }
    else
    {
                    fprintf(gpTsFile, "[INFO] TsCreateDescriptorSet() -> Rectangle vkAllocateDescriptorSets() succeeded at %d \n",  __LINE__);
    }
    memset((void *)&vkDescriptorBufferInfo, 0, sizeof(VkDescriptorBufferInfo));
    ...
    fprintf(gpTsFile, "[INFO] Rectangle vkUpdateDescriptorSets() is run successfully!!! at %d\n", __LINE__);
...
VkResult TsCreatePipeline(void)
{
    ...
    // For position
    vkVertexInputBindingDescription_array[1].binding = 1;   // corresponding layout (location = 1) in vertex shader
...
VkResult TsBuildCommandBuffers(void)
{
    ...
    for(uint32_t i = 0; i < swapchainImageCount; i++)
    {
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 
            1, // Binding Point
            1, // Number of buffer
            &vertexData_color_triangle.vkBuffer, // Which buffer
        ...
        vkCmdBindVertexBuffers(vkCommandBuffer_array[i], 
            1, // Binding Point
            1, // Number of buffer
            &vertexData_color_rectangle.vkBuffer, // Which buffer
            vkDeviceSize_offset_color   
        );

        // Here we should call Vulkan Drawing Functions
        vkCmdDraw(vkCommandBuffer_array[i],
            6,  // Kiti vertices draw karaychet
            1, // Kiti instances aahet 1
            0, // Drawing koothoon start karaych
            0  // From 1st instance
        );
