...
function initialize() {
    ...
    "{\n"+
     "let vPosition = mvpUniform.mvpMatrix * vec4(pos, 1.0);\n" + 
     "return vPosition;\n" +
    "}\n";
    ...
    /*// Get vertex positions from the sphere mesh
    const vertex_position = sphere.getVertices();
    console.log("initialize() Obtained vertex positions from sphere mesh successfully\n");
    ...
    bindingGroups_mvpUniform = createBindGroupForUniform(buffer_mvpUniform, 0, mvpUniformBufferSize, 0, bindGroupLayout_mvpUniform);
